...
function _JS_MobileKeyboard_Show(text, keyboardType, autocorrection, multiline, secure, alert, placeholder, characterLimit, data) {
    ...
    ks.showKeyboard({ defaultValue: keyboardSetting.value, maxLength: keyboardSetting.maxLength, multiple: keyboardSetting.multiple, confirmHold: keyboardSetting.confirmHold, confirmType: keyboardSetting.confirmType });
    addKeyboardListeners();
    hasExistingMobileInput = true;
}
function addKeyboardListeners() {
    ks.onKeyboardInput(keyboardInputlistener);
    ks.onKeyboardConfirm(keyboardConfirmlistener);
    ks.onKeyboardComplete(keyboardCompletelistener);
}
function removeKeyboardListeners() {
    ks.offKeyboardInput(keyboardInputlistener);
    ks.offKeyboardConfirm(keyboardConfirmlistener);
    ks.offKeyboardComplete(keyboardCompletelistener);
}
export default {
